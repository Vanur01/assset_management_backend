...
class UserController {
  ...
  createClient = asyncHandler(async (req, res) => {
    ...
    return sendResponse(res, 201, 'Client created successfully', {
      client: result,
    });
  });
  ...
  getClientById = asyncHandler(async (req, res) => {
    ...
    return sendResponse(res, 200, 'Client fetched successfully', {
      client,
    });
  });

  updateClient = asyncHandler(async (req, res) => {
    const client = await UserService.updateClient(
      req.params.id,
      req.body
    );

    return sendResponse(res, 200, 'Client updated successfully', {
      client,
    });
  });
  ...
  deleteClient = asyncHandler(async (req, res) => {
    ...
    const result = await UserService.deleteClient(
      req.params.id,
      permanent
    );
  ...
  toggleClientStatus = asyncHandler(async (req, res) => {
    ...
    const result = await UserService.toggleClientStatus(
      req.params.id,
      status
    );
  ...
  toggleAutoRenewal = asyncHandler(async (req, res) => {
    ...
    const result = await UserService.toggleAutoRenewal(
      req.params.id,
      enabled
    );
  ...
  createTeamMember = asyncHandler(async (req, res) => {
    ...
    const member = await UserService.createTeamMember(
      req.body,
      adminId,
      req.user._id
    );
  ...
  getAllTeamMembers = asyncHandler(async (req, res) => {
    const result = await UserService.getAllTeamMembers(
      req.user._id,
      req.query
    );
  ...
  getTeamMemberById = asyncHandler(async (req, res) => {
    ...
    const member = await UserService.getTeamMemberById(
      req.params.id,
      adminId
    );
  ...
  getTeamMemberDetails = asyncHandler(async (req, res) => {
    ...
    const member = await UserService.getTeamMemberDetails(
      req.params.id,
      adminId
    );
  ...
  updateTeamMember = asyncHandler(async (req, res) => {
    ...
    const member = await UserService.updateTeamMember(
      req.params.id,
      adminId,
      req.body
    );
  ...
  deleteTeamMember = asyncHandler(async (req, res) => {
    ...
    const result = await UserService.deleteTeamMember(
      req.params.id,
      adminId,
      permanent
    );
  ...
  getTeamStats = asyncHandler(async (req, res) => {
    ...
    return sendResponse(
      res,
      200,
      'Team stats fetched successfully',
      { stats }
    );
  });
  ...
  getMyRecentInspections = asyncHandler(async (req, res) => {
    ...
    const inspections = await UserService.getMyRecentInspections(
      req.user._id,
      limit
    );
    ...
    return sendResponse(
      res,
      200,
      'Recent inspections fetched successfully',
      inspections
    );
  });

  getMyAssignedAssets = asyncHandler(async (req, res) => {
    const assets = await UserService.getMyAssignedAssets(
      req.user._id
    );
  ...
  getMyScheduledTasks = asyncHandler(async (req, res) => {
    const tasks = await UserService.getMyScheduledTasks(
      req.user._id
    );
    ...
    return sendResponse(
      res,
      200,
      'Scheduled tasks fetched successfully',
      tasks
    );
  });
  ...
  getContactById = asyncHandler(async (req, res) => {
    const contact = await UserService.getContactById(
      req.params.id
    );
  ...
  deleteContact = asyncHandler(async (req, res) => {
    const result = await UserService.deleteContact(
      req.params.id
    );
